...
# Generated from PokeAPI; see scripts/fetch_pokeclicker_data.py.
...
# BerryType enum names, indexed to match save.farming.berryList /
# save.farming.unlockedBerries positions. Pulled verbatim from
# https://github.com/pokeclicker/pokeclicker BerryType.ts.
BERRY_NAMES: list[str] = [
    'Cheri', 'Chesto', 'Pecha', 'Rawst', 'Aspear', 'Leppa',  # 0-5
    'Oran', 'Sitrus', 'Persim', 'Razz', 'Bluk', 'Nanab',  # 6-11
    'Wepear', 'Pinap', 'Figy', 'Wiki', 'Mago', 'Aguav',  # 12-17
    'Iapapa', 'Lum', 'Pomeg', 'Kelpsy', 'Qualot', 'Hondew',  # 18-23
    'Grepa', 'Tamato', 'Cornn', 'Magost', 'Rabuta', 'Nomel',  # 24-29
    'Spelon', 'Pamtre', 'Watmel', 'Durin', 'Belue', 'Pinkan',  # 30-35
    'Occa', 'Passho', 'Wacan', 'Rindo', 'Yache', 'Chople',  # 36-41
    'Kebia', 'Shuca', 'Coba', 'Payapa', 'Tanga', 'Charti',  # 42-47
    'Kasib', 'Haban', 'Colbur', 'Babiri', 'Chilan', 'Roseli',  # 48-53
    'Snover', 'Micle', 'Custap', 'Jaboca', 'Rowap', 'Kee',  # 54-59
    'Maranga', 'Liechi', 'Ganlon', 'Salac', 'Petaya', 'Apicot',  # 60-65
    'Lansat', 'Starf', 'Enigma', 'Hopo',  # 66-69
]

assert len(BERRY_NAMES) == 70, f"berry roster is 70 names, got {len(BERRY_NAMES)}"

# MulchType enum names with the '_Mulch' suffix stripped, indexed to
# match save.farming.mulchList positions. Real saves observed in the
# wild may carry one extra slot beyond the enum length; name_for_mulch
# falls back to 'Slot N' for those.
MULCH_NAMES: list[str] = [
    'Boost',  # 0
    'Rich',  # 1
    'Surprise',  # 2
    'Amaze',  # 3
